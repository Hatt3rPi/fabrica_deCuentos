/*
  ...
  2. Storage Policies
    - Allows authenticated users to upload reference images
    - Allows users to access their own reference images
    - Allows users to delete their own reference images
    - Removes legacy policies and buckets
*/

-- Create bucket storage if not exists
DO $$
BEGIN
  IF NOT EXISTS (
