...
- Nuevo componente `OverlayLoader` con mensajes rotativos y soporte de timeout. Integrado en las etapas del asistente. Documentado en `docs/components/OverlayLoader.md`.
