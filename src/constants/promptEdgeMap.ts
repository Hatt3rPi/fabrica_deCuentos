export const promptEdgeMap: Record<string, string[]> = {
  ...
  PROMPT_ESTILO_BORDADO: ['generate-cover-variant', 'generate-thumbnail-variant', 'generate-image-pages'],
  PROMPT_ESTILO_MANO: ['generate-cover-variant', 'generate-thumbnail-variant', 'generate-image-pages'],
  PROMPT_ESTILO_RECORTES: ['generate-cover-variant', 'generate-thumbnail-variant', 'generate-image-pages'],
  PROMPT_ESTILO_DEFAULT: ['generate-image-pages'],
