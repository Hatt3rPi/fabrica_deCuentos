...
const Sidebar: React.FC = () => {
  ...
  const canAccessDebug = useRoleCheck([], ['system.debug']) || canManagePrompts; // Debug para admins generales
  ...
  return (
    <div className="h-screen flex flex-col bg-white dark:bg-gray-800 overflow-y-auto">
      {/* Logo section */}
